...
env = gym.make('MountainCar-v0')
agent3 = SarsaLambdaAgent(env)
steps_of_episode_Lambda_SARSA = agent3.train(n_episode=10000, learning_rate=0.0001, gamma=0.99, epsilon=0.0001, lamda=1)
env.close()
...
plt.plot(steps_of_episode_Lambda_SARSA, label="Lambda SARSA Linear Approximation")
plt.xlabel('episode')
